...
namespace VisionBase.Matching
{
    ...
    public class MatchingParam
	{
		...
		/// <summary> Í¼ÏñËõ·Å²ÎÊý</summary>
		public double mImageSizeScale;
        /// <summary>
        ...
        private void Init()
        {
            ...
            this.mAngleExtent = (double)360 * Math.PI / 180.0;
            this.mAngleStep = ((double)10 / 10.0) * Math.PI / 180.0;
            this.mContrast = (int)35;
            this.mMaxScale = (double)100 / 100.0;
			this.mImageSizeScale = 1.0;
            this.mMetric = "ignore_local_polarity'";
            this.mMinContrast = (int)10;
            this.mMinScale = (double)100 / 100.0;
            this.mNumLevel = (int)5;
            this.mOptimization = "none";
            this.mScaleStep = (double)10 / 1000.0;
            this.mStartingAngle = (double)(0) * Math.PI / 180.0;

            this.mMinScore = (double)50 / 100.0;
            this.mNumMatches = (int)1;
            this.mGreediness = (double)75 / 100.0;
            this.mMaxOverlap = (double)50 / 100.0;
            this.mSubpixel = "least_squares";
            this.mLastPyramidLevel = (int)1;
			
            this.mRecogRateOpt = (int)1;
            this.mRecogRate = (int)100;
            this.mRecogSpeedMode = MatchingParam.RECOGM_MANUALSELECT;
            this.mRecogManualSel = (int)100;
            this.mInspectMaxNoMatch = (int)100;
        }
		...
		public void setImageSizeScale(double val)
		{
			mImageSizeScale = val;		
		}
		/// <summary>
