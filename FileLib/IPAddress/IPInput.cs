...
namespace IPInputControl.Ctrl
{
    public partial class IPInput : UserControl
    {
        ...
        [Category("自定义属性"), Description("IP地址")]
        public string IP
        {
            get 
            {
                ...
                foreach(Control ctl in this.Controls)
                {
                    if(ctl is TextBox)
                    {
                        StrIP =StrIP+ ctl.Text.Trim()+".";
                    }
                }

                if (StrIP.Length > 1) StrIP = StrIP.TrimEnd('.');
                return StrIP; 
            }
            ...
            set
            {
                ...
                {
                    txt_1.Text = splitArr[0];
                    txt_2.Text = splitArr[1];
                    txt_3.Text = splitArr[2];
                    txt_4.Text = splitArr[3];
                }
            }
        }
