...
namespace ViewROI
{
	...
	{
		private double row1, col1;   // upper left   坐上角
		private double row2, col2;   // lower right  右下角
		private double midR, midC;   // midpoint     中点
		private double Width = 0;//矩形的边长
		/// <summary>Constructor</summary>
		public ROIRectangle1()
		{
			NumHandles = 5; // 4 corner points + midpoint  //句柄数为5，4个边角 +中心点
			activeHandleIdx = 4;   
		}
		...
		/// </summary>
		/// <param name="window">HALCON window</param>
		public override void displayActive(HalconDotNet.HWindow window)  //显示
		{
		...
		/// the interactive ROI
		/// </summary> 
		public override HTuple getModelData()   //获得矩形的数据
		{
		...
		public override void moveByHandle(double newX, double newY)   //移动句柄区域
		{
			double len1, len2;
			double tmp;
