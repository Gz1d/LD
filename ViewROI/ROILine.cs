...
namespace ViewROI
{
	...
	public class ROILine : ROI
	{
		...
		public ROILine(double row1In,double col1In,double row2In,double col2In)
		{
			midR = (row1In + row2In) * 0.5;
			midC = (col1In + col2In) * 0.5;
			row1 = row1In;
			row2 = row2In;
			col1 = col1In;
			col2 = col2In;
		...
		public void GetLine(out double Row1, out double Col1, out double Row2, out double Col2)
		{
			Row1 = row1;
			Col1 = col1;
			Row2 = row2;
