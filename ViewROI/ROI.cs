...
namespace ViewROI
{
	...
	public class ROI
	{
		...
		protected int   NumHandles;        //句柄数量
		protected int	activeHandleIdx;   //激活的句柄ID
		/// <summary>
		/// Flag to define the ROI to be 'positive' or 'negative'.
		/// </summary>
		protected int     OperatorFlag;
		/// <summary>Parameter to define the line style of the ROI.ROI线条格式的参数定义</summary>      
		public HTuple     flagLineStyle;
		/// <summary>Constant for a positive ROI flag.</summary>
		public const int  POSITIVE_FLAG	= ROIController.MODE_ROI_POS;    // 正的 ROI Flag
		/// <summary>Constant for a negative ROI flag.</summary>
		public const int  NEGATIVE_FLAG	= ROIController.MODE_ROI_NEG;    //负的 ROI Flag
		...
		/// </param>
		public virtual void createROI(double midX, double midY) { }    //创建ROI
		/// <summary>Paints the ROI into the supplied window.</summary>
		/// <param name="window">HALCON window</param>
		public virtual void draw(HalconDotNet.HWindow window) { }      //画ROI
		/// <summary> 
		...
		/// </returns>
		public virtual double distToClosestHandle(double x, double y)     //到最近句柄的距离
		{
			return 0.0;
		}
		...
		public virtual double getDistanceFromStartPoint(double row, double col)   //获得从起始点的距离
		{
			return 0.0;
		}
		/// <summary>
