...
namespace ViewROI
{
	...
	public class ROIController
	{
		...
		/// </summary>
		public const int MODE_ROI_NEG           = 22;  //减ROI
		...
		private ROI     roiMode;//new的是时候ROI不为空
		private int     stateROI;
		private double  currX, currY;


		/// <summary>Index of the active ROI object</summary>
		public int      activeROIidx;  //激活的ROI索引值
		public int      deletedIdx;    

		/// <summary>List containing all created ROI objects so far 所有创建的ROI集合</summary>
		...
		public HXLDCont ModelRoiContour;
		...
		public bool defineModelROI()
		{
			...
			if (stateROI == MODE_ROI_NONE) return true;
		...
		/// <summary>
		/// Paints all objects from the ROIList into the HALCON window  绘制所有的ROI对象到窗口
		/// </summary>
		...
		{
			if ((newX == currX) && (newY == currY))  return;
